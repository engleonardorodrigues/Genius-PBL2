...
ST_EVALUATE:
    ...
    #addi s3, s3, 1                                         # Incrementa contador de geração aleatória   
    addi t2, s1, 0                                          # Copia o registrador s1 para o t2
    sll  t2, s1, t0                                         # Rotaciona os bits de acordo com t0
    andi t2, t2, 0b11                                       # Aplica a máscara ao conjunto de bits
...
ST_INPUT_PLAYER_OR_PRNG:
   ...
   #addi t3, t3, 1 
   beq t3, s3, PRNG                                         # Se o contador de jogadas do jogador for igual ao contador de jogadas do PRNG, vai para o estado de gerar a sequência
   #addi t3, t3, 1 
